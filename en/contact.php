...
<?php
$query="SELECT * FROM su_pages WHERE page_language='en' and page_name='contact' ";
...
<?php
$query3="SELECT * FROM su_slider WHERE slider_language='en' and slider_status='active' and slider_position='contact' ";
                    ...
                    <form id="contact-form" name="contact_form" class="default-form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                 ...
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group inputBox">
                                        <select name="enquiry_type" id="enquiry_type" class="form-control inputBox">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group inputBox">
                                        ...
                                        <button class="thm-btn btn-style-two button cta submitquery submit" type="submit" data-loading-text="Please wait...">SEND</button>
                                    </div>
                                </div>
                            </div>
                        </form>
