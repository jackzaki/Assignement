...
<?php
$query="SELECT * FROM su_pages WHERE page_language='en' and page_name='register' ";
...
<?php
$query3="SELECT * FROM su_slider WHERE slider_language='en' and slider_status='active' and slider_position='register' ";
